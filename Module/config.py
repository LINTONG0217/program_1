...
# - competition
# - dual_slave
APP_PROFILE = "test_openart_track"
...
OPENART_TRACK_DEADBAND_PX = 18
OPENART_TRACK_VY_PER_PX = 0.18
OPENART_TRACK_MAX_VY = 24
OPENART_TRACK_FORWARD_SPEED = 20
OPENART_TRACK_PUSH_SPEED = 34
OPENART_TRACK_SEARCH_VW = 12
OPENART_TRACK_MIN_PIXELS = 120
OPENART_TRACK_PUSH_PIXELS = 2200
OPENART_TRACK_LOOP_MS = 20
