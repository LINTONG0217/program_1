...
HEADING_LOCK_TEST_FORWARD_SPEED = 65
HEADING_LOCK_FORWARD_SIGN = 1.0
HEADING_LOCK_FORWARD_ONLY_MS = 2000
HEADING_LOCK_TARGET_YAW_DEG = 0.0
HEADING_LOCK_YAW_KP = 1.4
HEADING_LOCK_YAW_MAX_SPEED = 28.0
