...
TEST_RUNTIME_C14_STOP_ENABLE = True
TEST_RUNTIME_C14_STOP_HOLD_MS = 700
...
LIDAR_TRACK_MAX_DISTANCE_MM = 520
LIDAR_TRACK_TARGET_DISTANCE_MM = 80
LIDAR_TRACK_DISTANCE_DEADBAND_MM = 55
LIDAR_TRACK_MIN_SIZE = 110
LIDAR_TRACK_CENTER_DEG = 45.0
LIDAR_SELECT_CENTER_BIAS_MM_PER_DEG = 12.0
LIDAR_TRACK_ANGLE_DEADBAND_DEG = 2.0
LIDAR_TRACK_ALIGN_FIRST_DEG = 10.0
LIDAR_TRACK_ALIGN_VX_SCALE = 0.45
LIDAR_TRACK_VX = 38
LIDAR_TRACK_REVERSE_VX = 0
LIDAR_TRACK_VY_PER_DEG = 3.8
LIDAR_TRACK_MAX_VY = 42
LIDAR_TRACK_SEARCH_VW = 24
LIDAR_TRACK_LOOP_MS = 10
LIDAR_TRACK_FILTER_ALPHA = 0.62
LIDAR_TRACK_HOLD_MS = 180
LIDAR_TRACK_MAX_VX_STEP = 70
LIDAR_TRACK_MAX_VY_STEP = 70
LIDAR_TRACK_MAX_VW_STEP = 55
HYBRID_LIDAR_ENABLE = False
LIDAR_TRACK_REQUIRE_LIDAR = False
LIDAR_TRACK_MAHONY_ENABLE = True
LIDAR_TRACK_IMU_CALIBRATE = False
LIDAR_TRACK_MAHONY_KP = 1.4
LIDAR_TRACK_MAHONY_KI = 0.02
LIDAR_TRACK_YAW_HOLD_P = 0.45
LIDAR_TRACK_YAW_HOLD_MAX_VW = 12
...
OPENART_TRACK_CENTER_X = 160
OPENART_TRACK_DEADBAND_PX = 10
OPENART_TRACK_VY_PER_PX = 0.28
OPENART_TRACK_MAX_VY = 42
OPENART_TRACK_FORWARD_SPEED = 34
OPENART_TRACK_PUSH_SPEED = 52
OPENART_TRACK_SEARCH_VW = 18
OPENART_TRACK_MIN_PIXELS = 120
OPENART_TRACK_PUSH_PIXELS = 2200
OPENART_TRACK_LOOP_MS = 10
HYBRID_OPENART_ENABLE = True
HYBRID_OPENART_TIMEOUT_MS = 120
HYBRID_OPENART_ALLOW_HELD = False
HYBRID_OPENART_MIN_CONF = 0.0
HYBRID_OPENART_MIN_PIXELS = 80
HYBRID_OPENART_CENTER_FIRST_PX = 34
HYBRID_OPENART_FORWARD_CENTER_PX = 18
HYBRID_OPENART_PUSH_CENTER_PX = 10
HYBRID_OPENART_ALIGN_VX = 0
HYBRID_OPENART_CENTERING_VX = 18
HYBRID_OPENART_VY_PER_PX = 0.40
HYBRID_OPENART_FORWARD_SPEED = 38
HYBRID_OPENART_PUSH_SPEED = 58
HYBRID_OPENART_PUSH_PIXELS = 1800
HYBRID_OPENART_MAX_VY = 52
HYBRID_OPENART_YAW_HOLD_ENABLE = False
HYBRID_SEARCH_VW = 26
HYBRID_SEARCH_DIRECTION = 1.0
